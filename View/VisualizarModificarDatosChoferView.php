    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar navbar-dark" style="background-color: #302E71" aria-label="Navegación principal" _mstaria-label="441961">
        <div class="container-fluid">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbar" style="font-size: 1rem">
                ...
                <li class="nav-item">
                        <a class="nav-link" href="./GestionChoferesView.php" _msthash="1070225" _msttexthash="177827">
...
<body class="">
    ...
    <div style="background-color: #302E71">
        ...
        <h5 style="color: white">Información del Chofer Seleccionado</h5>
        <br>
    </div>
    </br></br>
        ...
        <form>
            <div class="row">
                ...
                <div class="form-group col">
                    ...
                    <input type="text" class="form-control" placeholder="Ingrese la contraseña del chofer..." name="password" required=""> <br>
                </div>
