...
<body class="">
    ...
    <div style="background-color: #302E71">
        ...
        <h5 style="color: white">Editar información del administrador</h5>
        <br>
    </div>
    </br></br>
        ...
        <form>
            <div class="row">
                ...
                <label><b>Cédula:</b></label>
                    <input type="text" class="form-control" placeholder="Ingrese la nueva cédula..." name="cedula" required=""> <br>

                    <label><b>Nombre:</b></label>
                    <input type="text" class="form-control" placeholder="Ingrese el nuevo nombre..." name="nombre" required=""> <br>

                    <label><b>Apellidos:</b></label>
                    <input type="text" class="form-control" placeholder="Ingrese los nuevos apellidos..." name="apellidos" required=""> <br>

                   
                    <label><b>Grado:</b></label>
                    <input type="text" class="form-control" placeholder="Ingrese el nuevo grado..." name="cargo" required=""> <br>
                    
                    <label><b>Contraseña:</b></label>
                    <input type="text" class="form-control" placeholder="Ingrese su nueva contraseña..." name="cargo" required=""> <br>
