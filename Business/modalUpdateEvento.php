<div class="modal" id="modalUpdateEvento"  tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Visualizar Gira</h5>
  ...
  <form name="formEventoUpdate" id="formEventoUpdate" action="../Business/UpdateEvento.php" class="form-horizontal" method="POST">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" readonly class="form-control" name="fecha_inicio" id="fecha_inicio" placeholder="Fecha Inicio">
      </div>
    </div>
    <div class="form-group">
      <label for="fecha_fin" class="col-sm-12 control-label">Fecha Final</label>
      <div class="col-sm-10">
        <input type="text" readonly class="form-control" name="fecha_fin" id="fecha_fin" placeholder="Fecha Final">
      </div>
    </div>
    ...
    <div class="col-md-12 activado">
     ...
     <div class="modal-footer">
        <button type="submit" class="btn btn-success">Modificar Datos de la Gira</button>
